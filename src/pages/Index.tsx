        ...
        >
          <div className="max-w-lg">
            ...
            <a
              ...
              className="min-h-[48px] px-10 rounded-sm shadow-xl flex items-center gap-3 transition-colors hover:brightness-110 relative overflow-hidden group"
              style={{ backgroundColor: '#25D366', color: '#fff', fontFamily: 'Montserrat, sans-serif' }}
            >
              <WhatsAppIcon className="w-5 h-5 relative z-10" />
              <span className="relative z-10 font-medium text-sm uppercase tracking-[0.1em]">Comprar no WhatsApp</span>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="min-h-[44px] px-8 rounded-sm shadow-lg flex items-center gap-2"
            style={{ backgroundColor: '#25D366', color: '#fff', fontFamily: 'Montserrat, sans-serif' }}
          >
