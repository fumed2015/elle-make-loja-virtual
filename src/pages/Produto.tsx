  ...
  return (
    <div className="min-h-screen max-w-lg mx-auto">
      ...
      <div className="relative aspect-square bg-muted">
        ...
        <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-background/80 backdrop-blur flex items-center justify-center">
        ...
        {swatches.length > 0 && (
          <div>
            <p className="text-xs font-medium mb-2">
              Cor: {selectedSwatch?.name || "Selecione"}
            </p>
              ...
              {swatches.map((s: any, i: number) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedSwatch?.color === s.color ? "border-primary scale-110" : "border-border"
                  )}
        ...
        <div className="flex items-center gap-3 pt-2">
          <div className="flex items-center gap-2 bg-muted rounded-lg p-1">
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-md hover:bg-background transition-colors"
            >
