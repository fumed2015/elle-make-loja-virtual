          ...
          return (
            ...
            >
              ...
              <div className="flex gap-2 overflow-x-auto">
                ...
                {items.length > 4 && (
                  <div className="w-12 h-12 rounded-lg bg-muted flex items-center justify-center text-xs text-muted-foreground flex-shrink-0">
                    +{items.length - 4}
                  </div>
                )}
              </div>
              ...
              <div className="flex items-center justify-between pt-1 border-t border-border">
                ...
                <span className="text-[10px] text-muted-foreground">
                  {items.reduce((sum: number, it: any) => sum + (it.quantity || 1), 0)} itens
                </span>
              </div>
            </motion.div>
          );
