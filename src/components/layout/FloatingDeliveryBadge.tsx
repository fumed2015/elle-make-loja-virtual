    ...
    <AnimatePresence>
      {visible && !dismissed && (
        <motion.div
          ...
          className="fixed bottom-48 md:bottom-20 right-4 z-50 flex items-center gap-2 rounded-full bg-primary text-primary-foreground pl-3 pr-2 py-2 shadow-lg cursor-default select-none max-w-[220px]"
        >
