...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40">
      ...
      <div className="hidden md:flex bg-primary px-4 py-2">
        <div className="max-w-6xl mx-auto w-full flex items-center justify-between">
          <div className="flex items-center gap-5 text-xs text-primary-foreground/80">
      ...
      <div className="bg-card md:bg-card border-b border-border px-3 md:px-4 py-3 md:py-4">
